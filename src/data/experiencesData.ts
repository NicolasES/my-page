export const experiencesData = [
  {
    ...
    'period': '2022 - 2023',
    'description': `
      Autei com desenvolvedor backend para construções de APIs fornecendo dados internos para os clients frontend.
      <br /><br />
...

  {
    ...
    'period': '2020 - 2022',
    'description': `
      Autei com desenvolvedor backend no time de cadastro de clientes de um sistemas SaaS financeiro 
...

  {
    ...
    'period': '2014 - 2019',
    'description': `
      Atuei com desenvolvimento de sistemas SaaS, sites e APIs Utilizando PHP,
